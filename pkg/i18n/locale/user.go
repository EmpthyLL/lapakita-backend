...
var UserMessages = map[string]map[string]string{
	"en": {
		...
		"user.document_number_already_added": "This document number has already been added to your account",
	},
	"id": {
		// General Profile
		...
		"user.document_number_already_added": "Nomor dokumen ini sudah pernah Anda tambahkan sebelumnya",
	},
}
