...
const (
	...
	KeyUserPhoneCannotBeEmpty             MessageKey = "user.phone_cannot_be_empty"
	KeyUserPhonePrimaryRequired           MessageKey = "user.phone_primary_required"
	KeyUserPhoneMultiplePrimaryNotAllowed MessageKey = "user.phone_multiple_primary_not_allowed"
	...
	KeyUserPhoneRoleDuplicateInRequest    MessageKey = "user.phone_role_duplicate_in_request"
	KeyUserPhoneRoleAlreadyAssigned       MessageKey = "user.phone_role_already_assigned"
	...
	KeyUserDocumentNumberAlreadyAdded MessageKey = "user.document_number_already_added"
)
